...
client.on("ready", async () => {
  ...
  const r = new Discord.RichPresence()
    ...
    .setAssetsLargeImage('https://raw.githubusercontent.com/RayDev07/images/refs/heads/main/logo.png?size=1024')
    .setAssetsLargeText('CodeX On Top')
    .setAssetsSmallImage('https://raw.githubusercontent.com/RayDev07/images/refs/heads/main/logo.png')
